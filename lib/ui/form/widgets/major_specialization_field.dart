...
class MajorSpecializationField extends HookConsumerWidget {
  const MajorSpecializationField({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    controller.text =
        ref.read(lecturerFormControllerProvider).lecturer.majorSpecialization;
      ...
      if (previous?.isEdting != next.isEdting) {
        next.formState.maybeWhen(
            ...
            loadFieldsDataSuccess: (v) {
              controller.text = (v as Lecturer).majorSpecialization;
            });
      }
    });
    ...
    return FormBuilderTextField(
      ...
      decoration: const InputDecoration(labelText: 'التخصص العام',
        helperText: '',),
      ...
      onChanged: (value) {
        ...
        ref
            ...
            .onMajorSpecializationChanged(value);
      },
